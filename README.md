  ...
  var app = new Vue({         
    ...
    data: {                   
     UserList: [
      ...
      {'name': 'ericzheng', 'age': 22, 'address': '厦门的很多热的地方'},
...
<body>
  ...
  <script>
    ...
    setInterval(function () {
      app.UserList.push({'name': 'xiaoming', 'age': 18, 'address': '北京黑地下室'});
    }, 1000);
  </script>
</body>
</html>
...
> 有时间专门写一个这样的专题，如果需要可以邮件我。xiaoming666@126.com
...
? Author xiaoming <xiaoming666@126.com>               # => 作者
